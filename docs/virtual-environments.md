...
To work with SQLDev you need to install <a href="https://www.python.org/" class="external-link" target="_blank">Python</a>.

After that, you would need to **install** SQLDev and any other **packages** you want to use.
...
That will download a compressed file with the SQLDev code, normally from <a href="https://pypi.org/project/sqldev/" class="external-link" target="_blank">PyPI</a>.

It will also **download** files for other packages that SQLDev depends on.
