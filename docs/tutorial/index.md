...
In this tutorial you will learn how to use **SQLDev**.

## Type hints

If you need a refresher about how to use Python type hints (type annotations), check <a href="https://readyapi.khulnasoft.com/python-types/" class="external-link" target="_blank">ReadyAPI's Python types intro</a>.
