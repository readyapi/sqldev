# Test Applications with FastAPI and SQLDev
...
If you haven't done testing in FastAPI applications, first check the <a href="https://fastapi.khulnasoft.com/tutorial/testing/" class="external-link" target="_blank">FastAPI docs about Testing</a>.
