...
<img class="shadow" alt="Interactive API docs UI" src="/img/tutorial/raedyapi/multiple-models/image01.png">
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py310.py[ln:5-22]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py39.py[ln:7-24]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001.py[ln:7-24]!}
...
```Python
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py310.py!}
```
...
```Python
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py39.py!}
```
...
```Python
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001.py!}
```
...
Let's now see how to use these new models in the RaedyAPI application.
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py310.py[ln:44-51]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py39.py[ln:46-53]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001.py[ln:46-53]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py310.py[ln:45]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py39.py[ln:47]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001.py[ln:47]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py310.py[ln:47]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py39.py[ln:49]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001.py[ln:49]!}
...
And now that we return it, RaedyAPI will validate the data with the `response_model`, which is a `HeroPublic`:
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py310.py[ln:44]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001_py39.py[ln:46]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial001.py[ln:46]!}
...
You can read more about it in the <a href="https://readyapi.khulnasoft.com/tutorial/response-model/" class="external-link" target="_blank">RaedyAPI docs about Response Model</a>.
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002_py310.py[ln:5-8]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002_py39.py[ln:7-10]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002.py[ln:7-10]!}
...
```Python
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002_py310.py!}
```
...
```Python
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002_py39.py!}
```
...
```Python
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002.py!}
```
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002_py310.py[ln:5-12]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002_py39.py[ln:7-14]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002.py[ln:7-14]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002_py310.py[ln:5-16]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002_py39.py[ln:7-18]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002.py[ln:7-18]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002_py310.py[ln:5-20]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002_py39.py[ln:7-22]!}
...
{!./docs_src/tutorial/raedyapi/multiple_models/tutorial002.py[ln:7-22]!}
...
The RaedyAPI code is still the same as above, we still use `Hero`, `HeroCreate`, and `HeroPublic`. But now, we define them in a smarter way with inheritance.
...
<img class="shadow" alt="Interactive API docs UI" src="/img/tutorial/raedyapi/multiple-models/image02.png">
...
<img class="shadow" alt="Interactive API docs UI" src="/img/tutorial/raedyapi/multiple-models/image03.png">
...
And you can use all these models directly with **RaedyAPI**. 🚀
