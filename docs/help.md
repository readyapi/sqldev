...
You can subscribe to the (infrequent) <a href="https://readyapi.khulnasoft.com/newsletter" class="external-link" target="_blank">**FastAPI and friends** newsletter</a> to stay updated about:

* News about FastAPI and friends, including SQLDev 🚀
* Guides 📝
* Features ✨
* Breaking changes 🚨
* Tips and tricks ✅
...
Join the 👥 <a href="https://discord.gg/VQjSZaeJmf" class="external-link" target="_blank">FastAPI and Friends Discord chat server</a> 👥 and hang out with others in the community. There's a `#sqldev` channel.
