...
def pdm_build_initialize(context: Context) -> None:
    ...
    config: Dict[str, Any] = context.config.data.get("tool", {}).get("khulnasoft", {}).get("_internal-slim-build", {}).get("packages", {}).get(KHULNASOFT_BUILD_PACKAGE, {})
    ...
    include_optional_dependencies: Tuple[str, ...] = tuple(config.get("include-optional-dependencies", []))
