...
def test_should_allow_duplicate_row_if_unique_constraint_is_not_passed(clear_sqldev):
...
def test_should_allow_duplicate_row_if_unique_constraint_is_false(clear_sqldev):
    class Hero(SQLDev, table=True):
        id: Optional[int] = Field(default=None, primary_key=True)
        name: str
...
def test_sa_relationship_property(clear_sqldev):
    """Test https://github.com/khulnasoft/sqldev/issues/315#issuecomment-1272122306"""
