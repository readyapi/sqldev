...
from sqldev.sql.base import Executable
from sqldev.sql.expression import Select, SelectOfScalar
...
class Session(_Session):
    ...
    @deprecated(
        ...
        `session.exec()` is SQLDev's own short version with increased type
        annotations.
